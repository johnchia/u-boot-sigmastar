...
static u8 drv_spinor_complete_program_page(u8 u8_cmd, u32 u32_address, u8 *pu8_data, u32 u32_size)
{
    ...
    do
    {
        ...
        while (0 != u32_size)
        {
            ...
            {
                u32_bytes_to_load = 64 - ((unsigned long)pu8_data % 64);
...
static u8 drv_spinor_complete_read(u32 u32_address, u8 *pu8_data, u32 u32_size)
{
    ...
    if (0 != ((unsigned long)pu8_data % CONFIG_MIU_ADDR_ALIGN) || 0 != (u32_address % CONFIG_FLASH_ADDR_ALIGN)
        || u32_size < 64)
    {
    ...
    {
        u8_status = drv_spinor_read_data(u32_address & SPI_NOR_16MB_MASK, pu8_data, u32_size);
    }
